...
const PrivacyPolicy = (props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <CenteredSectionHeader sectionTitle="PRIVACY POLICY" />

      <View style={{ flex: 1, alignItems: "center" }}>
        <ScrollView
          style={{ flex: 1, padding: "6%", paddingBottom: 0, paddingTop: 0 }}
        >
          <Text
            style={[
              {
          ...
          >
            Books OnApp built the Books on App app as a Free app. This SERVICE
            is provided by OnApp at no cost and is intended for use as is. This
          ...
          >
            ...
            our Terms and Conditions, which is accessible at Books on App unless
            ...
            including but not limited to Email, Name, Address, Contact Number .
            ...
            * ﻿﻿To facilitate our Service; * ﻿﻿To provide the Service on our
            ...
            in analyzing how ourService is used. We want to inform users of this
            ...
            links to other sites. If you click on a third-party link, you will
            be directed to that site. Note that these external sites are not
            ...
            2021-09-01 Contact Us If you have any questions or suggestions about
            our Privacy Policy, do not hesitate to contact us at
            admin@booksonapp.co.za.{" "}
          </Text>
          <ButtonFilled
            title="BACK"
